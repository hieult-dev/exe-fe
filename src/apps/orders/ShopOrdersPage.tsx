...
export function ShopOrdersPage() {
  ...
  }, [orders, globalSearchQuery, statusFilter])
    ...
    <>
      <div className="flex flex-1 flex-col gap-2">
        <Toolbar
          ...
          start={
            <div>
              <h1 className="text-lg font-semibold text-slate-800">Yêu cầu mua hàng</h1>
              <p className="mt-0.5 text-sm text-slate-500">Quản lý tất cả đơn hàng đến — xác nhận, phân công và theo dõi tiến trình.</p>
            </div>
          }
          end={
        ...
        {selectedOrder && (
          ...
          >
            <p className="mb-4 mt-0 text-sm text-[#73849b]">Xem thông tin, xử lý và gán người giao hàng.</p>
        ...
        >
          <p className="mb-4 mt-0 text-sm text-[#73849b]">Nhập lý do từ chối để thông báo đến khách hàng.</p>
